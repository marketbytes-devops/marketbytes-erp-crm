...
const Overtime = ({ leadScope, employeeScope }) => {
 ...
 className="w-full pl-12 pr-4 py-3.5 bg-gray-50/50 border border-gray-200 rounded-xl text-sm focus:ring-4 focus:ring-black/5 focus:border-black outline-none transition-all placeholder:text-gray-400 font-medium"
 />
 </div>
 ...
 <p className="text-[11px] text-gray-500 line-clamp-2 leading-relaxed font-medium bg-gray-50/50 p-3 rounded-xl group-hover:bg-white group-hover:shadow-sm transition-all border border-transparent group-hover:border-gray-100 whitespace-pre-wrap">
