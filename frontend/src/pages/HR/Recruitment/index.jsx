...
const Recruitment = () => {
 ...
 >
 <td className="px-5 py-2.5 text-sm font-medium text-gray-900">{c.name || "—"}</td>
 <td className="px-5 py-2.5 text-sm text-gray-700">{c.email || "—"}</td>
 <td className="px-5 py-2.5 text-sm text-gray-700">{c.mobile || "—"}</td>
 <td className="px-5 py-2.5 text-sm text-gray-700">{c.designation || "—"}</td>
 <td className="px-5 py-2.5 text-sm">
 <span className="px-3 py-1.5 bg-gray-100 text-gray-800 rounded-full text-xs font-medium">
 {departments.find(d => d.id === c.department)?.name || "—"}
 </span>
 </td>
 <td className="px-5 py-2.5 text-sm">{getStatusBadge(c.status)}</td>
 <td className="px-5 py-2.5 text-sm text-center font-medium">{c.round || 1}</td>
 <td className="px-5 py-2.5 text-sm">
