            ...
            <div className="space-y-6">
              {chartData.length === 0 ? (
                ...
                chartData.map((data, idx) => (
                  <div
                    key={data.name}
                    className="group cursor-pointer hover:bg-gray-50/50 p-3 rounded-2xl transition-all active:scale-[0.98]"
            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
              ...
              >
                <div className="p-8 border-b border-gray-100 flex justify-between items-center bg-gray-50/50">
                  ...
                  <button
                    onClick={() => setSelectedDept(null)}
                    className="p-3 bg-white hover:bg-gray-100 rounded-2xl transition-all shadow-sm active:scale-90"
                  >
                    <X size={24} />
                  </button>
                </div>
                          ...
                          <div key={project.id} className="bg-white border border-gray-100 rounded-3xl p-6 hover:shadow-xl transition-all group">
                            <div className="flex flex-col lg:flex-row justify-between lg:items-center gap-6">
                              <div className="flex-1">
                                <h5 className="text-lg font-medium text-black mb-1">{project.name}</h5>
                            ...
                            <div className="mt-8">
                              ...
                              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                {(project.member_contributions || []).map(member => (
                                  <div key={member.id} className="bg-gray-50/50 rounded-2xl p-4 flex items-center gap-4 border border-gray-100/50 group-hover:bg-white transition-colors">
