...
const EmployeeProfile = () => {
 ...
 className="inline-flex items-center gap-3 px-5 py-2.5 text-sm bg-linear-to-r from-black to-gray-800 text-white font-medium rounded-xl hover:opacity-90 transition-all shadow-lg hover:shadow-xl"
 >
 ...
 {employee.mobile ? `${employee.country_code || "+91"} ${employee.mobile}` : "—"}
 </span>
 </div>
 </div>
 </div>
 ...
 <h4 className=" font-medium text-black">No Audit History</h4>
 ...
 <div className={`w-14 h-14 rounded-xl ${meta.bg} flex items-center justify-center ${meta.text} font-medium shadow-sm group-hover:scale-110 transition-transform`}>
 ...
 {r.comments && (
 <div className="mt-6 p-4 bg-white rounded-xl border border-gray-50 text-sm text-gray-600 leading-relaxed italic">
 "{r.comments}"
 </div>
 )}
 </div>
 ...
 <h4 className=" font-medium text-black capitalize">{activeTab} Ledger</h4>
