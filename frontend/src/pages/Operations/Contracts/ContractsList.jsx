                    ...
                    <div className="flex flex-wrap gap-4 items-center">
                        <div className="relative w-full lg:w-80">
                            <input
                                ...
                                className="w-full pl-12 pr-4 py-4 bg-gray-50 border border-gray-100 rounded-2xl focus:ring-2 focus:ring-black/5 focus:border-black outline-none transition-all text-sm"
                            />
                            <MdSearch className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400" size={22} />
                        </div>
                        <button
                            onClick={() => fetchContracts()}
                            className="p-4 bg-black text-white rounded-2xl hover:bg-gray-900 transition-all shadow-lg shadow-black/10 active:scale-95"
                        >
                            <MdSearch size={24} />
                        </button>
                    </div>
                    ...
                    <div className="flex items-center gap-3">
                        {hasPermission("contracts", "add") && (
                            <button
                                ...
                                className="flex items-center gap-2 px-6 py-4 bg-black text-white rounded-2xl hover:bg-gray-900 transition-all font-medium shadow-lg shadow-black/10 active:scale-95"
                            >
                                <MdAdd size={22} />
                        ...
                        <div className="relative">
                            <button
                                ...
                                className="flex items-center gap-2 px-6 py-4 bg-white border border-gray-100 text-black rounded-2xl hover:bg-gray-50 transition-all font-medium shadow-xs active:scale-95"
                            >
                ...
                <div className="flex flex-col lg:flex-row gap-8">
                    ...
                    <div className="w-full lg:w-72 shrink-0 bg-white p-8 rounded-3xl shadow-xs border border-gray-100 h-fit lg:sticky lg:top-8">
                        <div className="flex items-center justify-between mb-8 pb-4 border-b border-gray-50">
                            <h3 className="font-bold text-black flex items-center gap-2 text-lg font-syne uppercase tracking-tight">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="flex gap-3 pt-4 border-t border-gray-50">
                                <button
                                    onClick={() => fetchContracts()}
                                    className="flex-1 bg-black text-white py-4 rounded-2xl font-bold text-sm hover:bg-gray-900 transition-all shadow-lg shadow-black/5"
                                >
                                    Apply
                                </button>
                                <button
                                    onClick={resetFilters}
                                    className="flex-1 bg-gray-50 text-black py-4 rounded-2xl font-bold text-sm hover:bg-gray-100 transition-all"
                                >
                                    Reset
                                </button>
                            </div>
                        ...
                        <div className="p-8 border-t border-gray-50 flex flex-col md:flex-row justify-between items-center gap-6 bg-gray-50/30">
                            ...
                            <div className="flex gap-3">
                                <button
                                    ...
                                    className={`px-6 py-3 border border-gray-100 rounded-2xl text-sm font-bold transition-all ${!pagination.previous ? 'text-gray-300 bg-gray-50 cursor-not-allowed' : 'text-black bg-white hover:bg-black hover:text-white hover:shadow-lg hover:shadow-black/5 active:scale-95'}`}
                                ...
                                <button
                                    ...
                                    className={`px-6 py-3 border border-gray-100 rounded-2xl text-sm font-bold transition-all ${!pagination.next ? 'text-gray-300 bg-gray-50 cursor-not-allowed' : 'text-black bg-white hover:bg-black hover:text-white hover:shadow-lg hover:shadow-black/5 active:scale-95'}`}
