...
const ContractCreate = () => {
 ...
 toast.error('Failed to create contract. Please check all required fields.');
 } finally {
 setLoading(false);
 }
 };
 ...
 subtitle="Establish a new agreement with a client"
 variant="card"
 >
 ...
 <div className="space-y-2">
 <p className="text-sm font-bold text-black">Upload Contract Visual</p>
 <p className="text-xs text-gray-400 leading-relaxed max-w-[200px]">Represent your contract with a logo or official seal. PNG or JPG preferred.</p>
 {logoPreview && (
 <button
 type="button"
 ...
 <button onClick={() => setIsModalOpen(false)} className="p-3 hover:bg-gray-50 rounded-xl transition-colors">
 <MdClose size={24} />
 </button>
 </div>
