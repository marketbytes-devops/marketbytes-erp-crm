...
const TasksPage = ({ employeeScope = false, leadScope = false }) => {
 ...
 <div key={task.id} className="flex items-center justify-between p-4 bg-gray-50 rounded-xl border border-gray-100 hover:bg-white transition group shadow-xs">
