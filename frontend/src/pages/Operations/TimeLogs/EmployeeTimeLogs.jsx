...
const EmployeeTimeLogs = () => {
 ...
 className="flex items-center gap-2 px-5 py-2.5 text-sm bg-black text-white rounded-xl hover:bg-gray-900 transition text-sm font-medium whitespace-nowrap"
 >
 ...
 <th className="px-5 py-2.5 text-sm text-left text-xs font-medium text-gray-700 uppercase tracking-wider whitespace-nowrap">Work Frequency</th>
 <th className="px-5 py-2.5 text-sm text-left text-xs font-medium text-gray-700 uppercase tracking-wider whitespace-nowrap">Est. Earnings</th>
 <th className="px-5 py-2.5 text-sm text-right text-xs font-medium text-gray-700 uppercase tracking-wider whitespace-nowrap">Actions</th>
 </tr>
 </thead>
 ...
 <td className="px-5 py-2.5 text-sm whitespace-nowrap text-right">
 <button onClick={() => handleExpand(emp.id)}
