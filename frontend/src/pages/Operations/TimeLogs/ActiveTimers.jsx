...
const ActiveTimers = () => {
 ...
 <th className="px-5 py-2.5 text-sm text-left text-xs font-medium text-gray-700 uppercase tracking-wider whitespace-nowrap">Start Time</th>
 <th className="px-5 py-2.5 text-sm text-left text-xs font-medium text-gray-700 uppercase tracking-wider whitespace-nowrap">Duration</th>
 {canEdit && <th className="px-5 py-2.5 text-sm text-left text-xs font-medium text-gray-700 uppercase tracking-wider whitespace-nowrap">Actions</th>}
 </tr>
 </thead>
 ...
 >
 <td className="px-5 py-2.5 text-sm text-sm font-medium text-gray-500">#{t.id}</td>
 ...
 <td className="px-5 py-2.5 text-sm">
 <div className="flex items-center gap-2">
 <span className=" font-medium text-black tabular-nums">{formatDuration(t.duration)}</span>
