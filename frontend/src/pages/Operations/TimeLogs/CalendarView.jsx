...
const CalendarView = () => {
 ...
 {/* HEADER */}
 <div className="bg-white rounded-xl shadow-sm p-6 mb-6 flex flex-col md:flex-row justify-between items-center gap-6">
 ...
 {/* BODY */}
 <div className="bg-white border border-gray-200 rounded-xl overflow-hidden shadow-sm min-h-[600px]">
...
const DayView = ({ currentDate, productiveHoursData, loading }) => {
 ...
 <div className="max-w-md mx-auto bg-green-50 border-2 border-green-200 rounded-xl p-8">
