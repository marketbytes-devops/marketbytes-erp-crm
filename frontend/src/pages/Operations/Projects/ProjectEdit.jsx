...
const EditProjectPage = () => {
    ...
    const fetchData = async () => {
      try {
        ...
        setFormData({
          ...
          involvedDepartments: project.involved_departments?.map(d => d.id.toString()) || [],
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      formData.involvedDepartments.forEach((dId) => {
        formDataToSend.append("involved_departments_ids", dId);
      });
  ...
  const handleAddDepartment = async () => {
    ...
    try {
      ...
      setFormData({ ...formData, involvedDepartments: [res.data.id.toString()] });
  ...
  const handleAddCurrency = async () => {
    ...
    try {
      ...
      setFormData({ ...formData, currency: postRes.data.id.toString() });
      setNewCurrencyValue("");
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="relative top-0 sm:-top-1.5">
                ...
                <Input
                  ...
                  onChange={v => setFormData({ ...formData, involvedDepartments: v, projectMembers: [] })}
                />
              </div>
              ...
              <div className="space-y-4">
                ...
                {formData.involvedDepartments.length === 0 && (
                  <p className="text-xs text-amber-600 mt-1 font-medium">Select Involved Departments above to display available members.</p>
                )}
              </div>
            ...
            <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 gap-6">
              <Input label="Allocated Hours" type="number" value={formData.allocatedHours} onChange={e => setFormData({ ...formData, allocatedHours: e.target.value })} />
              <Input
                  label="Tenor"
                  type="select"
                  options={[
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="relative top-0 sm:-top-1.5">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <button type="button" onClick={() => setShowCurrencyModal(true)} className="p-1 rounded-full border border-green-600 text-green-600 hover:bg-green-600 hover:text-white transition">
                    <MdAdd className="w-4 h-4" />
                  </button>
                </div>
                <Input
