...
const ProjectDetails = () => {
 ...
 <div className="bg-gray-50 rounded-xl p-6 text-gray-700 text-sm leading-relaxed whitespace-pre-wrap">
 ...
 <div className="bg-amber-50 border border-amber-100 rounded-xl p-6 text-gray-700 text-sm leading-relaxed whitespace-pre-wrap italic">
 {project.notes}
 </div>
 </div>
 )}
 ...
 <tr>
 <th className="px-5 py-2.5 text-sm text-left">Task Name</th>
 <th className="px-5 py-2.5 text-sm text-left">Assignees</th>
 <th className="px-5 py-2.5 text-sm text-left">Due Date</th>
 <th className="px-5 py-2.5 text-sm text-left">Status</th>
 </tr>
 </thead>
 ...
 <div className="w-12 h-12 rounded-xl bg-black flex items-center justify-center text-white text-xl font-medium shadow-lg">
