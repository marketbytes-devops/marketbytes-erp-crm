...
const Scrum = ({ employeeScope = false, leadScope = false }) => {
 ...
 className="flex items-center gap-3 px-5 py-2.5 text-sm bg-black text-white rounded-xl hover:bg-gray-900 transition text-sm font-medium whitespace-nowrap"
 >
 ...
 <tr>
 <th className="px-5 py-2.5 text-sm text-left text-xs font-medium text-gray-700 uppercase tracking-wider whitespace-nowrap">Project / Task</th>
 ...
 <th className="px-5 py-2.5 text-sm text-left text-xs font-medium text-gray-700 uppercase tracking-wider whitespace-nowrap">Date</th>
 <th className="px-5 py-2.5 text-sm text-left text-xs font-medium text-gray-700 uppercase tracking-wider whitespace-nowrap w-1/5">Morning Memo</th>
 <th className="px-5 py-2.5 text-sm text-left text-xs font-medium text-gray-700 uppercase tracking-wider whitespace-nowrap w-1/5">Evening Memo</th>
 ...
 <td className="px-5 py-2.5 text-sm whitespace-nowrap min-w-[180px]">
 <Input
 type="select"
 value={item.status}
 ...
 <div key={item.id} className="flex items-center justify-between p-4 bg-gray-50 rounded-xl border border-gray-100 hover:bg-white transition group shadow-xs">
 ...
 >
 <div className="px-5 py-2.5 text-sm border-b border-gray-100 flex justify-between items-center">
 ...
 <div className="px-5 py-2.5 text-sm bg-gray-50 border-t border-gray-100 flex justify-end gap-3">
 ...
 <button onClick={handleSubmit} className="px-5 py-2.5 text-sm.5 bg-black text-white font-medium rounded-xl hover:bg-gray-900 transition shadow-lg">
 Create Scrum
 </button>
 </div>
 </motion.div>
