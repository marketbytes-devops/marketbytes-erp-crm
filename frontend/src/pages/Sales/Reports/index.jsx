...
const Reports = () => {
 ...
 <button className="flex items-center gap-2 px-5 py-2.5 text-sm.5 bg-white border border-gray-100 rounded-xl text-sm font-medium text-gray-700 hover:bg-gray-50 transition-all active:scale-95 shadow-sm">
