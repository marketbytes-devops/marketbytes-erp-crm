...
const Customers = () => {
 ...
 className="w-full pl-12 pr-4 py-3 bg-gray-50 border-none rounded-xl focus:ring-2 focus:ring-black transition-all outline-none font-medium text-sm"
 />
 </div>
 ...
 <div className="flex items-center gap-4">
 <div className="w-12 h-12 rounded-xl bg-indigo-50 border border-indigo-100 flex items-center justify-center text-indigo-600 font-medium shadow-sm">
 {item.name.charAt(0)}
 </div>
 <div>
 ...
 <td className="px-8 py-6">
 <div className="flex items-center gap-4">
 <div className="w-12 h-12 rounded-full bg-emerald-50 border border-emerald-100 flex items-center justify-center text-emerald-600 font-medium shadow-sm">
 {item.name.charAt(0)}
 </div>
 <div>
 <div className="font-medium text-gray-900 group-hover:text-black transition-colors">{item.name}</div>
 ...
 className="w-full px-5 py-[15px] bg-slate-50 border-none rounded-xl focus:ring-2 focus:ring-black outline-none font-medium text-sm appearance-none cursor-pointer"
 >
