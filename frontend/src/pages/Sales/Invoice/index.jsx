        ...
        <div className="bg-white rounded-4xl border border-gray-100 p-4 mb-8 flex flex-col md:flex-row gap-4 justify-between items-center shadow-sm">
          ...
          <div className="flex gap-4 w-full md:w-auto">
            ...
            <button
              ...
              className="flex items-center gap-2 px-6 py-3.5 bg-black text-white rounded-2xl hover:bg-gray-900 transition-all font-medium shadow-lg shadow-black/10 active:scale-95 whitespace-nowrap"
            >
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead className="bg-gray-50/50 border-b border-gray-50">
                <tr>
                  <th className="px-8 py-5 text-left text-[11px] font-medium text-gray-400 uppercase tracking-widest">Invoice Details</th>
                  <th className="px-8 py-5 text-left text-[11px] font-medium text-gray-400 uppercase tracking-widest">Client & Company</th>
                  <th className="px-8 py-5 text-left text-[11px] font-medium text-gray-400 uppercase tracking-widest">Due Date</th>
                  <th className="px-8 py-5 text-left text-[11px] font-medium text-gray-400 uppercase tracking-widest">Status</th>
                  <th className="px-8 py-5 text-right text-[11px] font-medium text-gray-400 uppercase tracking-widest">Amount</th>
                      ...
                      >
                        <td className="px-8 py-6">
                          <div className="flex items-center gap-3">
                            <div className="w-10 h-10 bg-slate-100 rounded-xl flex items-center justify-center text-slate-500 font-medium text-xs ring-1 ring-slate-200">
                              <FiFileText />
                            </div>
                            <div>
                              <div className="text-sm font-medium text-gray-900 leading-none mb-1">{inv.number}</div>
                              <div className="text-[10px] text-gray-400 font-medium uppercase tracking-tighter">Generated on {inv.date}</div>
                            </div>
                          </div>
                        </td>
                        <td className="px-8 py-6">
                        ...
                        <td className="px-8 py-6">
                          <span className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[10px] font-medium uppercase tracking-tighter border ${getStatusStyle(inv.status)}`}>
                        ...
                        <td className="px-8 py-6 text-right">
                          <div className="text-lg font-medium text-gray-900 tracking-tight">₹{inv.amount.toLocaleString()}</div>
            ...
            <div className="space-y-8 max-h-[70vh] overflow-y-auto pr-2 custom-scrollbar">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-6">
                  <h4 className="text-[10px] font-medium text-blue-600 uppercase tracking-widest">Client Selection</h4>
                ...
                <div className="space-y-6">
                  <h4 className="text-[10px] font-medium text-purple-600 uppercase tracking-widest">Date Configuration</h4>
              ...
              <div className="p-6 bg-slate-50 rounded-4xl border border-slate-100 space-y-6">
                <h4 className="text-sm font-medium text-gray-900 border-b border-slate-200 pb-4">Line Items</h4>
                {/* Simplified Item Row */}
                ...
                <button className="flex items-center gap-2 text-xs font-medium text-black border-2 border-dashed border-slate-200 w-full py-3 justify-center rounded-2xl hover:bg-white hover:border-black transition-all">
              ...
              <div className="flex flex-col items-end gap-2 pr-4">
                ...
                <div className="flex justify-between w-64 text-xl font-medium text-gray-900 pt-2 border-t border-gray-100"><span>Total:</span> <span>₹0.00</span></div>
              </div>

              <div className="flex justify-end gap-4 pt-6">
                <button onClick={() => setShowInvoiceModal(false)} className="px-8 py-4 text-sm font-medium text-gray-600 hover:text-black transition">Discard</button>
                <button className="px-12 py-4 bg-black text-white rounded-2xl font-medium shadow-xl shadow-black/10 hover:translate-y-[-2px] transition-all">Generate & Send</button>
              </div>
            </div>
          }
        />
