...
const Pipeline = () => {
 ...
 className="w-full pl-12 pr-4 py-3.5 bg-gray-50/50 border-none rounded-xl focus:ring-2 focus:ring-black outline-none transition-all font-medium text-sm"
 />
 </div>
 ...
 className="w-full pl-11 pr-8 py-3.5 bg-gray-50/50 border-none rounded-xl outline-none focus:ring-2 focus:ring-black font-medium text-sm appearance-none cursor-pointer"
 >
