...
const Sidebar = ({ toggleSidebar }) => {
 ...
 <button
 onClick={item.toggle}
 className={`w-full flex items-center justify-between px-4 py-2 rounded-xl text-sm font-medium transition-all duration-300 group relative overflow-hidden ${item.isOpen
 ...
 className={({ isActive }) =>
 `flex items-center gap-3.5 px-4 py-2 rounded-xl text-sm font-medium transition-all duration-300 group relative overflow-hidden ${isActive
