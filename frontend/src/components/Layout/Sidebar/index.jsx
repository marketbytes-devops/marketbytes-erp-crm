    ...
    return (
      ...
      >
        <div className="p-8 border-b border-gray-100">
          <div className="h-12 bg-gray-200 rounded-xl animate-pulse mx-auto" />
        </div>
              ...
              >
                {item.subItems ? (
                  <>
                    <motion.button
                      onClick={item.toggle}
                      className={`w-full flex items-center justify-between px-5 py-4 rounded-xl text-sm font-medium transition-all duration-300 group relative overflow-hidden ${
                        item.isOpen
                      ...
                      {item.isOpen && (
                        ...
                        >
                          {item.subItems.map((subItem) => (
                            <motion.li key={subItem.to}>
                              <NavLink
                                to={subItem.to}
                                end
                                onClick={() => isMobile() && toggleSidebar?.()}
                                className={({ isActive }) =>
                                  `flex items-center gap-3.5 px-5 py-3.5 rounded-xl text-sm font-medium transition-all duration-300 group relative overflow-hidden ${
                                    isActive
                  ...
                  <NavLink
                    ...
                    onClick={() => isMobile() && toggleSidebar?.()}
                    className={({ isActive }) =>
                      `flex items-center gap-3.5 px-5 py-4 rounded-xl text-sm font-medium transition-all duration-300 group relative overflow-hidden ${
                        isActive
                          ? "bg-black text-white shadow-inner"
