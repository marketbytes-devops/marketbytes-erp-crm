...
const NotificationPreferences = () => {
 ...
 <div key={type.key} className="flex items-center justify-between p-4 rounded-xl hover:bg-gray-50 transition-colors">
 <div>
 ...
 className="w-full bg-white/10 border-none rounded-xl px-5 py-4 text-white font-bold outline-none focus:ring-2 focus:ring-white/20 transition-all cursor-pointer"
 >
